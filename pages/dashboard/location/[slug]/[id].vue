  ...
  <div class="page-content-top">
    ...
    >
      <p class="text-sm italic text-gray-500">
        <span v-if="locationLog.startedAt !== locationLog.endedAt" class="">
          {{ formatDate(locationLog.startedAt) }} /
          {{ formatDate(locationLog.endedAt) }}
        </span>
        <span v-else class="">{{ formatDate(locationLog.startedAt) }}</span>
      </p>
    ...
    <AppDialog
      :is-open="isOpen"
      title="Are you sure?"
      description="Deleting this location log cannot be undone. Do you really want to do is?"
